...
class TranslationNotesAICLI:
    ...
    def _create_parser(self) -> argparse.ArgumentParser:
        ...
        parser = argparse.ArgumentParser(
            ...
            epilog="""
Examples:
  %(prog)s                                     # Run until all work complete (default)
  ...
  %(prog)s --mode continuous --immediate-mode      # Run with immediate AI processing
        ...
        mode_group.add_argument(
            '--mode', 
            choices=['continuous', 'once', 'complete'], 
            default='complete',
            help='Run mode: continuous monitoring, one-time processing, or complete until no work (default: complete)'
        )
        ...
        processing_group.add_argument(
            '--immediate-mode',
            action='store_true',
            help='Use immediate/synchronous AI processing instead of batch processing for predictable timing'
        )
    ...
    def _handle_main_operations(self, app, args: argparse.Namespace) -> int:
        ...
        try:
            ...
            if args.mode == 'continuous':
                ...
                app.logger.info("Running complete mode - processing until no work found...")
                app.run_complete(dry_run=args.dry_run)
                return 0
